...
namespace lve 
{
	...
	{
		assert(configInfo.pipelineLayout != VK_NULL_HANDLE && "Cannot create a graphics pipeline:: no pipelineLayout provided in configInfo");
		assert(configInfo.renderPass != VK_NULL_HANDLE && "Cannot create a graphics pipeline:: no pipelineLayout provided in configInfo");
